...
import "./db"; // This will now connect to PostgreSQL
...
// General rate limiting configuration (less restrictive)
const generalLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: process.env.RATE_LIMIT_MAX ? parseInt(process.env.RATE_LIMIT_MAX) : 200, // Increased from 100
...
// Apply general rate limiter (more lenient)
